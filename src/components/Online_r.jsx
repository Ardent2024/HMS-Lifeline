  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        setModalMessage("Login successful. Downloading file...");
        setMessageType("success");
        setShowModal(true);

        // File download logic
        const downloadResponse = await axios.get("https://online-report.onrender.com/api/onrelo/download-report", { responseType: "blob" });
      ...
      const errorMessage = error.response?.data?.error || "An error occurred during the request.";
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <Link to="/" className="nav-link active mt-3 ho">Home</Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link active mt-3 ho" href="#">Online report</a>
                </li>
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle active mt-3" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">More</a>
